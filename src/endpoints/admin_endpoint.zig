...
pub fn init(a: std.mem.Allocator, participants_path: []const u8, participants: *Participants) !Self {
    return .{
        .allocator = a,
        .participants = participants,
        .endpoint = zap.SimpleEndpoint.init(.{
            .path = participants_path,
            .get = listOrSaveParticipants,
            .post = null,
            .put = null,
            .delete = null,
...
fn listOrSaveParticipants(e: *zap.SimpleEndpoint, r: zap.SimpleRequest) void {
